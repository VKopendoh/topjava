...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <form name="filter" id="filter" method="get" action="meals/filter">
            <div class="form-group">
                ...
                <button class="btn btn-primary" type="reset" onclick="resetFilter()"><spring:message code="meal.reset"/></button>
            </div>
        </form>
        <hr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <%--  <spring:message code="${meal.new ? 'meal.add' : 'meal.edit'}"/>--%>
